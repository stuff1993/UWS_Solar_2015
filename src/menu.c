...
void lcd_display_MPPTPower (void)
{
	...
	if (len < 20)
	{
		sprintf(buffer, "%*s", 20 - len, "");
		lcd_putstring(1,20 - len, buffer);
	}
...
/******************************************************************************
** Function name:		_lcd_emptyRow
**
** Description:			Clears 1 row
**
** Parameters:			1. Row number to clear (0-3)
** Returned value:		None
**
******************************************************************************/
